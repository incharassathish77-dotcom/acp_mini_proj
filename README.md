...
A fully interactive, keyboard-driven 2D vector graphics editor that runs entirely inside the Windows console. It renders shapes onto a character canvas, supporting ANSI colors and filled/wireframe render modes.
